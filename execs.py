...
doc = {
  ...
  "query": {
    "bool": {  
      "must" : {
        "query_string" : {
            "fields": ["sender","recipient","bcc"],
            "query": "jeff.skilling@enron.com OR kenneth.lay@enron.com OR ken_lay@enron.com OR klay@enron.com OR kenneth_lay@enron.com OR andrew.fastow@enron.com OR richard.causey@enron.com OR ken.rice@enron.com OR kenneth.rice@enron.com OR joe.hirko@enron.com OR michael.kopper@enron.com OR ben.glisan@enron.com OR mark.koenig@enron.com OR tim.despain@enron.com OR david.delainey@enron.com OR tim.belden@enron.com OR tbelden@enron.com OR jeff.richter@enron.com OR sherron.watkins@enron.com"
        }
      }
    }
  }
